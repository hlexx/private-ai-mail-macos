...
enum Migrator {
    static func migrate(_ db: DatabaseQueue) throws {
        ...
        migrator.registerMigration(
            "M019_AttachmentExtractionVersionText",
            migrate: M019_AttachmentExtractionVersionText.migrate
        )
        migrator.registerMigration(
            "M020_ActionOutbox",
            migrate: M020_ActionOutbox.migrate
        )
        migrator.registerMigration(
            "M021_ActionOutboxSensitivity",
            migrate: M021_ActionOutboxSensitivity.migrate
        )
